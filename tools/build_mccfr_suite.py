...
PROFILES = (
    ("reference", "Reference", "decks/reference.json"),
    ("avaros", "Avaros Line", "decks/avaros-line.json"),
    ("mara", "Mara Rear", "decks/mara-rear.json"),
    ("sera", "Sera Support", "decks/sera-support.json"),
)
